    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          <span className="text-[#1E3358] text-[10px] font-mono tabular-nums flex-shrink-0">
        ...
        <header className="max-w-4xl mx-auto w-full px-4 sm:px-6 pt-8 pb-4 text-center flex flex-col items-center gap-4">
          ...
          <div className="relative w-full max-w-md mt-2">
            ...
            <input
              ...
              className="w-full bg-[#060C1A]/70 border border-[#1E3358]/50 rounded-2xl pl-10 pr-4 py-3 text-sm text-[#7AC4FF] placeholder-[#1E3358] outline-none focus:border-[#2A5499] transition-colors"
            />
            {search && (
          ...
          {filtered ? (
            ...
            <div className="flex flex-col gap-3">
              ...
              {filtered.length === 0 ? (
                ...
                <div key={i}>
                  <p className="text-[9px] uppercase tracking-widest text-[#1E3358] mb-1.5 pl-1">
            ...
            <div className="flex gap-5">
              ...
              <div className="flex-1 min-w-0 flex flex-col gap-3">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[9px] text-[#1E3358] bg-[#0A1525] px-2 py-0.5 rounded-full border border-[#1E3358]/40">
