      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="flex-1 max-w-3xl mx-auto w-full px-4 sm:px-6 py-12 flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* Vagus nerve diagram */}
            <div className="flex flex-col items-center gap-1 p-5 rounded-2xl font-mono t-caption"
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3 p-5 rounded-2xl"
              ...
              <div className="flex flex-col gap-2">
                <p className="t-caption" style={{ color: '#F87171' }}>Fast, rigid rhythm (low HRV — stressed)</p>
                <p className="t-body tracking-[0.05em]" style={{ color: '#F87171' }}>♥♥♥♥♥♥♥♥♥♥♥♥</p>
              </div>
              <div className="flex flex-col gap-2">
                <p className="t-caption" style={{ color: '#4AE8A0' }}>Slow, variable rhythm (high HRV — calm)</p>
                <p className="t-body tracking-[0.4em]" style={{ color: '#4AE8A0' }}>♥ &nbsp; ♥ &nbsp;&nbsp; ♥ &nbsp; ♥ &nbsp;&nbsp; ♥</p>
              </div>
            </div>

            <div className="flex flex-col gap-2 px-4 py-3 rounded-xl"
              style={{ background: ts.cardBg, border: `1px solid ${ts.border}` }}>
              <p className="t-caption font-semibold" style={{ color: ts.textPrimary }}>Low HRV →</p>
              <p className="t-caption" style={{ color: ts.textMuted }}>Stressed, fatigued, poor recovery</p>
              <p className="t-caption font-semibold mt-1" style={{ color: ts.textPrimary }}>High HRV →</p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div key={item} className="flex items-center gap-2 px-3 py-2 rounded-xl"
                  style={{ backgroundColor: ts.cardBg, border: `1px solid ${ts.border}` }}>
                  <span className="t-label" style={{ color: ts.accent }}>✓</span>
            ...
            <div className="flex flex-col gap-3 p-5 rounded-2xl text-center"
              style={{ background: ts.accent + '10', border: `1px solid ${ts.accent}30` }}>
              <p className="t-body font-medium" style={{ color: ts.textPrimary }}>Try it right now</p>
              <div className="flex justify-center gap-6">
                <div>
                  <p className="text-2xl font-light" style={{ color: ts.accent }}>5s</p>
                  <p className="t-caption" style={{ color: ts.textMuted }}>Inhale</p>
                </div>
                <div className="flex items-center t-heading" style={{ color: ts.textDim }}>→</div>
                <div>
                  <p className="text-2xl font-light" style={{ color: ts.accentLight }}>5s</p>
                  <p className="t-caption" style={{ color: ts.textMuted }}>Exhale</p>
                </div>
              </div>
              <p className="t-caption" style={{ color: ts.textMuted }}>
              ...
              <Link to="/breathing"
                className="self-center px-6 py-2.5 rounded-xl text-white t-caption font-medium transition-all hover:opacity-90"
            ...
            {[
              ...
              <Link key={situation} to={href}
                ...
                <div className="flex-1">
                  <p className="t-body font-medium mb-1" style={{ color: ts.textPrimary }}>{situation}</p>
                  <p className="t-caption mb-1" style={{ color: ts.accent }}>→ {technique}</p>
                  <p className="t-caption" style={{ color: ts.textMuted }}>{result}</p>
                </div>
                <span className="t-caption self-center flex-shrink-0" style={{ color: ts.textMuted }}>→</span>
              </Link>
            ))}
          </div>
