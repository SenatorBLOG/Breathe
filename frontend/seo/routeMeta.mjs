...
export const ROUTE_META = {
  '/learn': {
    ...
    intro: 'Twenty-nine free guides: the core breathing techniques with step-by-step instructions, what to reach for in a specific moment — anxiety, focus, public speaking, running, kids, sleep, blood pressure — comparisons to help you choose, and the science of why slow breathing changes how you feel. No account needed for any of it.',
    links: [
